...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (less-css-mode terraform-mode yaml-mode mmm-mode protobuf-mode markdown-mode rainbow-delimiters company cider projectile zenburn-theme clojure-mode paredit))))
(custom-set-faces
