...
When in programming mode bind =C-c C-c= to run ='compile=.
...
#+begin_src elisp
  ...
  ;;  (setenv "LSP_USE_PLISTS" "true")
    ...
    :init
    ;; (require 'lsp-mode)
    ;; ;; might need to register custom notificiton handlers
    ;; (lsp-register-client
    ;;  (make-lsp-client :new-connection (lsp-stdio-connection '("odoo_ls_server"))
